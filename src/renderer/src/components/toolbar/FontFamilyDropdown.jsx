...
function FontFamilyDropdown() {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute top-full left-0 mt-1 w-48 max-h-64 overflow-y-auto bg-white rounded-lg shadow-lg border border-gray-100 py-1 z-50">
          {Object.entries(FONT_NAMES).map(([key, name]) => (
            <button
              ...
              className={`
                ...
                ${currentFont === key ? 'bg-blue-50 text-blue-600' : 'text-gray-700'}
              `}
